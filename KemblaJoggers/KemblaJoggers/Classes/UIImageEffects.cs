...
namespace KemblaJoggers
{
    public static class UIImageEffects
    {
        ...
        {
            var tintColor = UIColor.FromWhiteAlpha(0.1f, 0.1f);

            return ApplyBlur(self, blurRadius: 15, tintColor: tintColor, saturationDeltaFactor: 1.8f, maskImage: null);
        }
        ...
        public static UIImage ApplyDarkEffect(this UIImage self)
        {
            ...
            return ApplyBlur(self, blurRadius: 20, tintColor: tintColor, saturationDeltaFactor: 2.5f, maskImage: null);
        }
